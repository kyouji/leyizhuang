...
public class TdManagerManagerController {
	...
	public String diysiteroleList(Integer page, Integer size,
		...
		map.addAttribute("role_page",
				tdDiySiteRoleService.findAll(page, size));
	...
	public String diysiteRoleEdit(Long id, String __VIEWSTATE, ModelMap map,
		...
		if (null != id) {
			map.addAttribute("tdDiySiteRole",
					tdDiySiteRoleService.findOne(id));
