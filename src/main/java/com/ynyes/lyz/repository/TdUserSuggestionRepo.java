...
public interface TdUserSuggestionRepo
	...
	//0111
	Page<TdUserSuggestion>findByCreateTimeAfterAndCreateTimeBeforeAndCategoryId(Date date1, Date date2, Long categoryId,  Pageable pageable);
	//1000
	...
	//1011
	Page<TdUserSuggestion>findByCreateTimeBeforeAndCategoryIdAndContentContaining(Date date2, Long categoryId, String keywords, Pageable pageable);
	//1100
	Page<TdUserSuggestion>findByCreateTimeAfterAndContentContaining(Date date1, String keywords, Pageable pageable);
	//1101
	Page<TdUserSuggestion>findByCreateTimeAfterAndCategoryIdAndContentContaining(Date date1, Long categoryId, String keywords, Pageable pageable);
	//1110
	Page<TdUserSuggestion>findByCreateTimeAfterAndCreateTimeBeforeAndContentContaining(Date date1, Date date2, String keywords, Pageable pageable);
	//1111
	Page<TdUserSuggestion>findByCreateTimeAfterAndCreateTimeBeforeAndCategoryIdAndContentContaining(Date date1, Date date2, Long categoryId, String keywords, Pageable pageable);
}
