...
MySocialShare=function(e){
	...
	var d={
		bubble:{holder:'<a class="msb_main" title="My Networks" alt="My Networks">'+'<img src="[IMAGE_URL]" title="My Networks" alt="My Networks"/>'+"</a>"+'<div class="msb_network_holder"></div>',
	...
	var m={
		facebook:{profile_url:"http://www.facebook.com/[HANDLE]",name:"Facebook"},
		google:{profile_url:"https://plus.google.com/[HANDLE]",name:"Google Plus",window:"width=600,height=330,scrollbars=no"},
		twitter:{profile_url:"https://twitter.com/[HANDLE]",name:"Twitter",window:"width=560,height=257,scrollbars=no"},
		pinterest:{profile_url:"http://pinterest.com/[HANDLE]",name:"Pinterest"},
		linkedin:{profile_url:"http://www.linkedin.com/profile/view?id=[HANDLE]",name:"LinkedIn",window:"width=520,height=570,scrollbars=no"},
		dribbble:{profile_url:"http://dribbble.com/[HANDLE]",name:"Dribbble"},
		email:{profile_url:"mailto:[HANDLE]",name:"Email"},
		instagram:{profile_url:"http://instagram.com/[HANDLE]",name:"Instagram"},
		vimeo:{profile_url:"http://vimeo.com/[HANDLE]",name:"Vimeo"},
		youtube:{profile_url:"http://www.youtube.com/user/[HANDLE]",name:"YouTube"}
	};
