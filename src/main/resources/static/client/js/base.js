...
break;
case 2:
window.open("/login"+proIDs[0]+"&s2="+proIDs[1]);
break;
case 3:
window.open("/login"+proIDs[0]+"&s2="+proIDs[1]+"&s3="+proIDs[2]);
break;
default:
alert("��ѡ��2-3����Ʒ���жԱȣ�");
return;}}
