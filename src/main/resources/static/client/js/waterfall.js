function waterfallList(mainid,boxid,_clname,_elname,_between,_width,_outwidth){
	var _main = $("#"+mainid);
	var _box = $("#"+boxid);
	var _arr = $("#"+boxid+" > li");
	var _win = _outwidth;//当前可视宽度
	...
	//第一次带入值
	var _str = "<div class='"+_clname+"' style='position:relative;float:left;_display:inline;width:"+_width+"px;margin:0 "+_bet02+"px;_width:"+(_width-_num*2)+"px;'></div>";
	_main.html(_str);
