...
(function(A, o) {
    ...
    function za(a, b) {
        ...
        k = [], r, p = /((?:\\.|[^\s>])+|[\s>])/g; r = p.exec(a);) r[1] !== " " && k.push(r[1]);
        r = [];
    ...
    if (!A.KindEditor) {
                    ...
                    if (!g && a == e.start) g = !0;
                        ...
                        if (!d && b.type == 3 && B(a.nodeValue).length > 0) {
                            ...
                            b.replaceWith(n);
                                ...
                                for (var a = b,
                                j; (j = b.first()) && j.children().length == 1;) b = j;
                                j = b.first();
        ...
        function(a, b) {
            na.prototype[b] = function(a) {
                this.select();
                P(this.doc, b, a); (!l || N(b, "formatblock,selectall,insertorderedlist,insertunorderedlist".split(",")) >= 0) && this.selection();
                return this
            }
        });
        ...
        E(R, {
            ...
            remove: function() {
                var a = this; (l && z < 7 || O) && f(a.win).unbind("scroll");
                a.div.remove();
                m(a,
                function(b) {
                    a[b] = null
            ...
            create: function() {
                ...
                p = b.edit = yb({
                    ...
                    afterCreate: function() {
                        ...
                        p.textarea.keyup(function(a) { ! a.ctrlKey && !a.altKey && Nb[a.which] && b.options.afterChange && b.options.afterChange.call(b)
                        });
                ...
                f(A).bind("resize", b._fullscreenResizeHandler), h.select("fullscreen"), k.first().css("visibility", "hidden"), k.last().css("visibility", "hidden")) : (ea && f(A).bind("scroll",
                function() {
                    b._scrollPos = ba()
                }), b.resizeType > 0 ? Sa({
                    moveEl: g,
