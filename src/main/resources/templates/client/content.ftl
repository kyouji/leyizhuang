...
<div class="w100">
		...
		<div class="wrapper">
				...
				<div class="right-extra" style="margin: 0px;">
					...
					<div>
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<img src="<#if goods??>${goods.coverImageUri!''}</#if>" />
							</span>
						</div>
						<!--缩图开始-->
			...
			<div class="details_details">
				...
				<span class="addcart">
					<a href="/cart/init?id=${goods.id}" title="加入购物车" class="addcartorange">加入购物车</a>
				</span>
			</div>
			<!--右部商品展示-->
				...
				<div class="c_combination_title">推荐组合</div>
					<div class="c_combination_btm">
						<div class="c_combination_btm_list">
							<ul>
								<li><a href="/goods/${goods.id}" title="${goods.name!''}"> <img src="${goods.coverImageUri!''}" /></a> 
			...
			<div class="c_R">
				...
				<div id="tab5" class="c_R_info php_z">
					<div class="c_R_info_title">
						<span>产品详情</span> <label>买手机 就到正品惠客</label>
					</div>
					${goods.detail!''}
				</div>
				<!--售后-->
