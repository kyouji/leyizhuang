...
<title><#if site??>${site.seoTitle!''}-</#if>信息中心</title>
        ...
        <div class="article_box">
            ...
            <div class="article_page">
                <div class="article_page_01">
                    <#if info_page.first>
                        <a href="javascript:;" title="上一页">上一页：无</a>
                    <#else>
                        <a href="/info/list/${mid}?catId=${catId!''}?page=${info_page.number-1}" title="上一页">上一页</a>
                    </#if>
                </div>
                <div class="article_page_02">
                    <#if info_page.totalPages-1 <= info_page.number>
                        <a href="javascript:;" title="下一页">下一页：无</a>
                    <#else>
                        <a href="/info/list/${mid}?catId=${catId!''}?page=${info_page.number+1}" title="下一页">下一页</a>
                    </#if>
                </div>
            </div>
        </div>
