...
<link rel="stylesheet" type="text/css" href="/client/css/return_2.css"/>
  ...
  <div class="content_2">
		...
		<div class="content_2_2">
			...
			<div class="content_2_2_2">
			  <ul>
			    <li class="li_5">等待商家处理申请</li>
			    <li class="li_6"><strong>·</strong>如果商家同意，退货申请将达成需要您退货给商家</li>
			    <li class="li_6"><strong>·</strong>如果商家拒绝，将需要您修改退货申请</li>
			  </ul>
			</div>
			<div>
			    <a href="/user/return/list" style="float:right;margin-right:100px;" >查看退货记录</a>
			</div>
		</div>
    </div>
</div>
