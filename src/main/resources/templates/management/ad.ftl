...
<html lang="en">
	...
	<body>
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
					    <input type="text" id="id-total-num" class="hide" value="<#if ad_total??>${ad_total}</#if>" />
						<div class="row">
						    <#include "/management/ad/ad_add.ftl">
                            <div id="id-modify"></div>
							<div id="id-table" class="col-sm-12">
								<!-- PAGE CONTENT BEGINS -->
                                <div class="table-header">
                                    <a id="id-new" href="javascript:void(0)" class="col-sm-1 btn btn-success btn-sm">添加广告</a> 
                                ...
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="30%" class="center">图片</th>
                                    ...
                                    <tbody id="id-tbody">
                                            <#include "/management/ad/ad_tbody.ftl">
                                    </tbody>
                                </table>
		...
		<!--全选反选提交删除等-->
        <script src="/js/management/ad.js" type="text/javascript"></script>
