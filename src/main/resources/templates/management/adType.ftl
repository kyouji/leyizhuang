...
<html lang="en">
	...
	<body>
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
						    <#include "/management/ad/type_add.ftl">
                            <div id="id-modify"></div>
							<div id="id-table" class="col-sm-12">
								<!-- PAGE CONTENT BEGINS -->
                                <div class="table-header">
                                    <a id="id-new" href="javascript:void(0)" class="col-sm-2 btn btn-success btn-sm">添加广告类型</a> 
                                ...
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="70%" class="center">名称</th>
                                            <th width="10%" class="center">编辑</th>
                                        </tr>
                                    </thead>

                                    <tbody id="id-tbody">
                                            <#include "/management/ad/type_tbody.ftl">
                                    </tbody>
                                </table>
		...
		<!--全选反选提交删除等-->
        <script src="/js/management/adType.js" type="text/javascript"></script>
