...
<html lang="en">
	...
	<body>
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
					    <input type="text" id="id-total-num" class="hide" value="<#if news_total??>${news_total}</#if>" />
						<div class="row">
						    <#include "/management/news/news_add.ftl">
                            <div id="id-modify"></div>
							<div id="id-table" class="col-sm-12">
								<!-- PAGE CONTENT BEGINS -->
                                <div class="table-header">
                                    <a id="id-new" href="javascript:void(0)" class="col-sm-1 btn btn-success btn-sm">添加资讯</a> 
                                ...
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="20%" class="center">标题</th>
                                            <th width="10%" class="center">类型</th>
                                            <th width="20%" class="center">创建时间</th>
                                            <th width="10%" class="center">是否显示</th>
                                            <th width="10%" class="center">点击量</th>
                                            <th width="10%" class="center">编辑</th>
                                        </tr>
                                    </thead>

                                    <tbody id="id-tbody">
                                            <#include "/management/news/news_tbody.ftl">
                                    </tbody>
                                </table>
		...
		<!--全选反选提交删除等-->
        <script src="/js/management/news.js" type="text/javascript"></script>
