...
<html lang="en">
	...
	<body>
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
					    <input type="text" id="id-total-num" class="hide" value="<#if ad_total??>${total}</#if>" />
						<div class="row">
                                ...
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="15%" class="center">订单编号</th>
                                            <th width="20%" class="center">下单日期</th>
                                            <th width="15%" class="center">用户</th>
                                            <th width="10%" class="center">总金额</th>
                                    ...
                                    <tbody id="id-tbody">
                                            <#include "/management/order/order_tbody.ftl">
                                    </tbody>
                                </table>
		...
		<!--全选反选提交删除等-->
        <script src="/js/management/order.js" type="text/javascript"></script>
