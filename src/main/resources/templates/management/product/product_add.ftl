<div id="id-add" class="hide">
    ...
    <input type="text" id="new-goods-id" name="id" value="" hidden/>
    <div class="col-sm-12">
    ...
    <div class="col-sm-12" style="margin-top: 10px;">
        <!-- 手机属性 -->
        <div id="id-phone-prop" class="row div-prop hide">
            <div class="col-sm-12">
                ...
                <div class="col-sm-11">
                    <#list phone_property_map["brandName"] as value>
                        <#if value_index gt 0>
                        <a href="javascript:void(0)" class="selectProp">${value}</a>
                        </#if>
                    </#list>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" name="priceSpan" class="hide" value=""/>
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" name="networkType" class="hide" value=""/>
                    
                    <div class="col-sm-11">
                    <#list phone_property_map["networkType"] as value>
                        <#if value_index gt 0>
                        <a href="javascript:void(0)" class="multiSelectProp">${value}</a>
                        </#if>
                    </#list>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" name="backCamera" class="hide" value=""/>
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" name="coreNumber" class="hide" value=""/>
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" name="os" class="hide" value=""/>
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" name="screenSize" class="hide" value=""/>
            ...
            <!-- 数码属性 -->
            <div id="id-digit-prop" class="row div-prop hide">
                <div class="col-sm-12">
                    <label class="col-sm-1 control-label blue">品牌</label>
                    <input type="text" name="brandName" class="hide" value=""/>
                    <div class="col-sm-11">
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" name="memorySize" class="hide" value=""/>
            ...
            <!-- 运营商属性 -->
            <div id="id-carrier-prop" class="row div-prop hide">
                <div class="col-sm-12">
                    <label class="col-sm-1 control-label blue">品牌</label>
                    <input type="text" name="brandName" class="hide" value=""/>
                    <div class="col-sm-11">
