...
<html lang="en">
	...
	<body>
                                ...
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="10%" class="center">角色</th>
                                            <th width="15%" class="center">手机号</th>
                                            <th width="10%" class="center">是否使能</th>
                                            <th width="20%" class="center">上次登录</th>
                                            <th width="10%" class="center">编辑</th>
                                        </tr>
                                    </thead>

                                    <tbody id="id-tbody">
                                            <#include "/management/user/user_tbody.ftl">
                                    </tbody>
                                </table>
		...
		<!--全选反选提交删除等-->
        <script src="/js/management/user.js" type="text/javascript"></script>
