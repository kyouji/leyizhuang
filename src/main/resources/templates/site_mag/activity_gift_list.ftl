...
<form name="form1" method="post" action="/Verwalter/activity/gift/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/activity/gift/edit"><i></i><span>添加</span></a></li>
...
<tbody>
    <tr class="odd_bg">
        ...
        <th align="left" width="15%">活动名</th>
        <th align="left" width="15%">产品类别</th>
        <th align="left" width="40%">赠品</th>
    ...
    <#if activity_gift_Page?? && activity_gift_Page.content??>
    <#list activity_gift_Page.content as activity>
        <tr>
            <td align="center">
            ...
            <td>${activity.id?c}</td>
            <td><a href="/Verwalter/activity/gift/edit?id=${activity.id?c}">${activity.name!"无"}</a></td>
            <td>${activity.categoryName!"无"}</td>
            <#--<td>
            ...
            <td><#if activity.giftName??>${activity.giftName!''}</#if></td>
            <td>
...
<!--内容底部-->
<#assign PAGE_DATA=activity_gift_Page />
