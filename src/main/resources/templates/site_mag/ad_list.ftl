...
<form name="form1" method="post" action="/admin/ad/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/admin/ad/edit"><i></i><span>新增</span></a></li>
    ...
    <#if ad_page??>
        <#list ad_page.content as item>
            <tr>
                ...
                <td><a href="/admin/ad/edit?id=${item.id}">${item.title!""}</a></td>
                ...
                <td align="center">
                    <a href="/admin/ad/edit?id=${item.id}">修改</a>
                </td>
            </tr>
        </#list>
    </#if>
