...
<form name="form1" method="post" action="/Verwalter/setting/city/list" id="form1">
<div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    <th  width="8%">选择</th>
    <th align="left" width="20%">城市名</th>
    <th align="left" width="60%">是否开启配送服务</th>
    ...
    <#if city_page??>
        <#list city_page.content as item>
            <tr>
                ...
                <td align="left"><a href="/Verwalter/setting/city/edit?id=${item.id?c}">${item.cityName!""}</a></td>
