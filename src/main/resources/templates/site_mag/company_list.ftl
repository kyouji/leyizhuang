...
<form name="form1" method="post" action="/Verwalter/setting/company/list" id="form1">
<div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    <th  width="8%">选择</th>
    <th align="left" width="20%">子公司名</th>
    <th align="left" width="60%">备注</th>
    <th align="center" width="10%">排序号</th>
  </tr>

    <#if company_page??>
        <#list company_page.content as item>
            <tr>
                <td align="center">
                ...
                <td align="left"><a href="/Verwalter/setting/company/edit?id=${item.id?c}">${item.name!""}</a></td>
