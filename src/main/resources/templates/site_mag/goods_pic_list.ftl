...
<form name="form1" method="post" action="/admin/content/list?cid=${cid!""}&mid=${mid!""}" id="form1">
<div>
...
<ul style="width: 1189px;">
    ...
    <li style="margin-right: 15.75px;">
        <div class="details <#if !content.coverImageUri??>nopic</#if>">
            ...
            <h1><span><a href="/admin/article/edit?cid=${cid!""}&mid=${mid!""}&id=${content.id!""}&__VIEWSTATE=${__VIEWSTATE!""}">${content.title!""}</a></span></h1>
            ...
            <div class="foot">
              <p class="time">${content.onSaleTime!""}</p>
              <a href="/admin/article/edit?cid=${cid!""}&mid=${mid!""}&id=${content.id!""}&__VIEWSTATE=${__VIEWSTATE!""}" title="编辑" class="edit">编辑</a>
            </div>
        </div>
    </li>
    </#list>
