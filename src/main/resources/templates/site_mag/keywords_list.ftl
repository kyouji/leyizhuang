...
<form name="form1" method="post" action="/admin/keywords/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/admin/keywords/edit"><i></i><span>新增</span></a></li>
    ...
    <#if keywords_page??>
        <#list keywords_page.content as keywords>
            <tr>
                ...
                <td align="center"><a href="/admin/keywords/edit?id=${keywords.id}">${keywords.title!""}</a></td>
                ...
                <td align="center">
                    <a href="/admin/keywords/edit?id=${keywords.id}">修改</a>
                </td>
            </tr>
        </#list>
    </#if>
