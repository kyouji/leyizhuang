...
<form name="form1" method="post" action="/admin/manager/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/admin/manager/edit"><i></i><span>新增</span></a></li>
    ...
    <#if manager_page??>
        <#list manager_page.content as item>
            <tr>
                ...
                <td align="center"><a href="/admin/manager/edit?id=${item.id}">${item.username!""}</a></td>
                ...
                <td align="center">
                    <a href="/admin/manager/edit?id=${item.id}">修改</a>
                </td>
            </tr>
        </#list>
    </#if>
