...
<form name="form1" method="post" action="/admin/view/navi/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/admin/view/navi/edit"><i></i><span>新增</span></a></li>
  ...
  <tr class="odd_bg">
    ...
    <#list navi_bar_item_list!! as item>
        <tr>
            ...
            <td align="center"><a href="/admin/view/navi/edit?id=${item.id}">${item.title!""}</a></td>
            ...
            <td align="center">
                <a href="/admin/view/navi/edit?id=${item.id}">修改</a>
            </td>
        </tr>
    </#list>
