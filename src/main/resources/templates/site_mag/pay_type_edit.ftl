...
<form name="form1" method="post" action="/admin/order/setting/pay/save" id="form1">
<div>
...
<!--导航栏-->
<div class="location">
  <a href="/admin/order/setting/pay/list" class="back"><i></i><span>返回列表页</span></a>
  <a href="/admin/center" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="/admin/order/setting/pay/list"><span>支付方式</span></a>
  <i class="arrow"></i>
  <span>编辑支付方式</span>
</div>
