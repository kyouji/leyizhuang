...
<body class="mainbody">
<form name="form1" method="post" action="/admin/product/category/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/admin/product/category/edit"><i></i><span>新增</span></a></li>
    ...
    <#list category_list as cat>
        <tr>
            ...
            <td>
                ...
                <a href="/admin/product/category/edit?id=${cat.id!""}">${cat.title!""}</a>
            </td>
            <td>${cat.callIndex!""}</td>
            <td><input name="listSortId" type="text" value="${cat.sortId!""}" class="sort" onkeydown="return checkNumber(event);"></td>
            <td align="center">
                <a href="/admin/product/category/edit?id=${cat.id!""}&sub=1">添加子类</a>
                <a href="/admin/product/category/edit?id=${cat.id!""}">修改</a>
            </td>
        </tr>
    </#list>
    </#if>
