...
<form name="form1" method="post" action="/Verwalter/setting/subdistrict/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/setting/subdistrict/edit"><i></i><span>导入</span></a></li>
        <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
        <li><a onclick="return ExePostBack('btnDelete');" id="btnDelete" class="del" href="javascript:__doPostBack('btnDelete','')"><i></i><span>删除行政街道</span></a></li>
      </ul>
    </div>
  </div>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <#if subdistrict_page??>
        <#list subdistrict_page.content as item>
            <tr>
                <td align="center">
...
<!--内容底部-->
<#assign PAGE_DATA=subdistrict_page />
