...
<form method="post" action="/admin/user/level/save" id="form1">
<div>
...
<div class="tab-content" style="display: block;">
    <dl>
        <dt>用户等级</dt>
        <dd>
            <input name="levelId" type="text" value="<#if user_level??>${user_level.levelId!""}</#if>" ajaxurl="/admin/user/level/check/levelId<#if user_level??>?id=${user_level.id}</#if>" class="input txt100" datatype="n1-2" sucmsg=" ">
    ...
    <dl>
        <dt>等级名称</dt>
        <dd>
            <input name="title" type="text" value="<#if user_level??>${user_level.title!""}</#if>" ajaxurl="/admin/user/level/check/title<#if user_level??>?id=${user_level.id}</#if>" class="input txt100" datatype="s" sucmsg=" ">
