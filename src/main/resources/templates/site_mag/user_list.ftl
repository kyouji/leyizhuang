...
<form name="form1" method="post" action="/admin/user/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/admin/user/edit"><i></i><span>新增</span></a></li>
            ...
            <tr>
                ...
                <td>
                  <div class="user-box">
                    ...
                    <span>
                      <a class="amount" href="/admin/user/point/list?userId=${user.id}" title="积分">积分</a>
                      <a class="point" href="/admin/user/collect/list?userId=${user.id}" title="关注商品">关注商品</a>
                      <a class="msg" href="/admin/user/recent/list?userId=${user.id}" title="浏览历史">浏览历史</a>
                      <#if user.roleId?? && user.roleId==1>
                          <a class="sms" href="/admin/user/reward/list?userId=${user.id}" title="返现记录">返现记录</a>
                      </#if>
                    </span>
                  </div>
                </td>
                ...
                <td align="center">
                    <a href="/admin/user/edit?id=${user.id}&roleId=${roleId!""}">修改</a> | 
                    <a href="/admin/user/edit?id=${user.id}&roleId=${roleId!""}&action=view">查看</a></td>
              </tr>
        </#list>
    </#if>
